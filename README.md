...
- [ ] [Visual index](https://puppet.com/docs/puppet/latest/lang_visual_index.html)
- [X] [Basics](https://puppet.com/docs/puppet/latest/lang_summary.html)
...
- [X] [Variables](https://puppet.com/docs/puppet/latest/lang_variables.html)
- [X] [Resources](https://puppet.com/docs/puppet/latest/lang_resources.html)
- [ ] [Resources (advanced)](https://puppet.com/docs/puppet/latest/lang_resources_advanced.html)
- [X] [Relationships and ordering](https://puppet.com/docs/puppet/latest/lang_relationships.html)
...
- [X] [Resource default statements](https://puppet.com/docs/puppet/latest/lang_defaults.html)
...
- [X] [Tags](https://puppet.com/docs/puppet/latest/lang_tags.html)
- [X] [Run stages](https://puppet.com/docs/puppet/latest/lang_run_stages.html)
## 
